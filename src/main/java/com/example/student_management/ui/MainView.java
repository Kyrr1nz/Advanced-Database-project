...
public class MainView extends VerticalLayout implements BeforeEnterObserver {
    ...
    public MainView(StudentService studentService,
        ...
        this.managePart = new ManagementComponent(studentService, classService, majorService, courseSectionService, enrollmentService);
        ...
        ManagementComponent managePart = new ManagementComponent(studentService, classService, majorService, courseSectionService, enrollmentService);
